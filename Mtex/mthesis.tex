...
% 日本語題目 (in LaTeX)
%
\title{ボランティアコンピューティング資源活用によるクラウドゲーミングのQoE向上に関する研究}
%
% 日本語題目 (in plain text)
%
...
% 英語題目 (in LaTeX)
%
\etitle{Research About QoE Approaving of Cloud Gaming Using Resouces of Volunteer Computing}
%
% 英語題目 (in plain text)
%
%   注: (in LaTeX)と同じ場合は指定する必要なし。
...
\clearpage
\input{5_anlytics.tex}

\clearpage
\input{6_conclusion_and_futurework.tex}
